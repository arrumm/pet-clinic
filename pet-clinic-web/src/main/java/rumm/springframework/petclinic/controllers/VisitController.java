...
public class VisitController {
    ...
    /**
     * Called before each and every @RequestMapping annotated method. 2 goals: - Make sure we always have fresh data - Since we do not use the session scope, make sure that Pet object always has an id
